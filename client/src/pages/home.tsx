                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-teal-700 leading-relaxed">
                        Use Windows+H to dictate your rough thoughts - no need to worry about formatting, punctuation, or structure. Just speak naturally and we'll polish it for you.
                      </p>
                    </div>
                  </div>
                </div>
